...
document.getElementById('footer04-1f').remove();
...
myFooterDiv.innerHTML = `
    <footer class="d-flex align-items-center justify-content-center py-3"
        style="background-color: #2E481A; color: white;">
        <a href="https://respati.ac.id/" target="_blank">
        <img src="assets/images/logo-unriyo1.png" alt="Logo" class="me-2" style="width: 50px;"> </a>
        <p class="mbr-text mbr-fonts-style display-7 mb-0">
		© Copyright 2025 SDK Leworere - Yeremias - Informatika - Universitas Respati Yogyakarta
        </p>
    </footer>
`;
